      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (data.status == true) {
            ...
            $('.error-message').text(data.message || "Project could not be updated. Please try again later.");
            // Show error alert
            $('.alert-danger').removeClass('fade hide').addClass('show').show();
            $('html, body').animate({
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (data.status == true) {
            ...
            $('.alert-success').hide();
            // Populate error alert message
            $('.error-message').text(data.message || "Service could not be updated. Please try again later.");
        ...
        error: function (xhr, status, error) {
          ...
          $('.alert-success').hide();
          // Populate error alert message
          $('.error-message').text("Service could not be updated. Please try again later.");
