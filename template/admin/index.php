...
<div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-xl-6 grid-margin stretch-card flex-column">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                          <p class="mb-2 text-muted">MEP</p>
                          <h6 class="mb-0">563</h6>
                        </div>
                        <div>
                          <p class="mb-2 text-muted">BIM</p>
                          <h6 class="mb-0">720</h6>
                        </div>
                        <div>
                          <p class="mb-2 text-muted">3D</p>
                          <h6 class="mb-0">5900</h6>
                        </div>
                        <div>
                          <p class="mb-2 text-muted">2D</p>
                          <h6 class="mb-0">11000</h6>
                        </div>
                      </div>
              ...
              <div class="row h-100">
                <div class="col-md-6 stretch-card grid-margin grid-margin-md-0">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                      <p class="text-muted">Civil Infrastructure Analytics</p>
                      <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <div class="col-xl-6 grid-margin stretch-card flex-column">
              <h5 class="mb-2 text-titlecase mb-4">Engineering Services</h5>
              <div class="row h-100">
              ...
              <div class="card">
                <div class="card-body border-bottom">
                  <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <h6 class="mb-2 mb-md-0 text-uppercase fw-medium">Job Booking Details</h6>
                    <div class="dropdown">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3 mt-4">
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center">
                      <p class="text-muted">Structural </p>
                      <h5>87k</h5>
                      <div class="d-flex align-items-baseline">
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center">
                      <p class="text-muted">BIM Modeling</p>
                      <h5>92k</h5>
                      <div class="d-flex align-items-baseline">
                        <p class="text-success mb-0">0.7%</p>
                        <i class="typcn typcn-arrow-up-thick text-success"></i>
                      </div>
                    </div>
...
<?php
  ...
  <script src="<?php echo ASSETS_DIR;?>/js/dashboard.js"></script>
